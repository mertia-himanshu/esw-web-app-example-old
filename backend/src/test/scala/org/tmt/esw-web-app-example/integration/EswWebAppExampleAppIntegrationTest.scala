package org.tmt.esw-web-app-example.integration
...
import org.tmt.esw-web-app-example.EswWebAppExampleWiring
import org.tmt.esw-web-app-example.core.models.{AdminGreetResponse, GreetResponse, UserInfo}
import org.tmt.esw-web-app-example.http.HttpCodecs

import scala.concurrent.duration.DurationInt
import scala.concurrent.{Await, ExecutionContext}

class EswWebAppExampleAppIntegrationTest extends ScalaTestFrameworkTestKit with AnyWordSpecLike with Matchers with HttpCodecs {
  ...
  val esw-web-app-exampleAppPort                    = 8085
  val esw-web-app-exampleWiring                     = new EswWebAppExampleWiring(Some(esw-web-app-exampleAppPort))
  val appConnection: HttpConnection    = esw-web-app-exampleWiring.settings.httpConnection
  ...
  protected override def beforeAll(): Unit = {
    ...
    esw-web-app-exampleWiring.start(Metadata.empty).futureValue
  ...
  protected override def afterAll(): Unit = {
    ...
    esw-web-app-exampleWiring.stop().futureValue
    super.afterAll()
  }

  "EswWebAppExampleWiring" must {

    "start the esw-web-app-example app and register with location service" in {
